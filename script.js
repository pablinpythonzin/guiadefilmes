...
const filmes = [
    {
        ...
        generoNome: "Ação",
        sinopse:
            "Peter Parker precisa lidar com as consequências de sua identidade revelada e acaba enfrentando ameaças de outros universos.",
        classificacao: "12",
        nota: "8.7",
...

    {
        ...
        generoNome: "Comédia",
        sinopse:
            "Riley está entrando na adolescência e novas emoções aparecem em sua mente.",
        classificacao: "L",
        nota: "8.5",
...

    {
        ...
        generoNome: "Sci-Fi",
        sinopse:
            "Um grupo de astronautas parte em uma missão através de um buraco de minhoca em busca de um novo lar para a humanidade.",
        classificacao: "10",
        nota: "8.7",
...

    {
        ...
        generoNome: "Ação",
        sinopse:
            "Batman investiga uma série de crimes cometidos por um misterioso assassino em Gotham City.",
        classificacao: "14",
        nota: "8.0",
...

    {
        ...
        generoNome: "Drama",
        sinopse:
            "Arthur Fleck é um homem ignorado pela sociedade que inicia uma transformação que mudará Gotham para sempre.",
        classificacao: "16",
        nota: "8.4",
...

    {
        ...
        generoNome: "Sci-Fi",
        sinopse:
            "Jake Sully e sua família enfrentam novas ameaças enquanto procuram segurança entre os povos dos oceanos de Pandora.",
        classificacao: "12",
        nota: "7.6",
...

    {
        ...
        generoNome: "Drama",
        sinopse:
            "A história do físico J. Robert Oppenheimer e de sua participação no desenvolvimento da bomba atômica.",
        classificacao: "16",
        nota: "8.6",
...

    {
        ...
        generoNome: "Comédia",
        sinopse:
            "Dois agentes do FBI precisam se disfarçar como duas socialites para protegê-las e acabam vivendo situações hilárias.",
        classificacao: "12",
        nota: "7.0",
...
function criarCard(filme) {
    ...
    imagem.addEventListener(
        ...
        function () {
            this.src =
                "https://placehold.co/500x750/121212/ffffff?text=Poster+Indisponivel";
        },
        { once: true }
    );
